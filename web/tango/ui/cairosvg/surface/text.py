...
def text(surface, node):
    ...
    font_family = 'WenQuanYi Micro Hei' # Edit by weet <2012-9-18, 11:15>
    
    # ==============================================================================
    #  There is a *BUG* here. expect is >>>'microsoft yahei' but get >>>"'microsoft yahei'" 
    # ==============================================================================    
    # font_family = (node.get("font-family") or "sans-serif").split(",")[0]
    # if font_family.find("'") > -1 or font_family.find('"') > -1:
    ...
    # print 'text_extents::', text_extents

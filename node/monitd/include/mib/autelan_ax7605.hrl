%%%Autelan AX7605 AQ2110-H
%%----------------------------------------------------------------------
%% ac discover -- ac配置(发现)
%%----------------------------------------------------------------------
-define(Ac,[
     {acName,          "1.3.6.1.4.1.31656.6.1.2.1.2.1.0"},
     {softVersion,     "1.3.6.1.4.1.31656.6.1.2.1.1.2.0"},
     {maxApLimit,       "1.3.6.1.4.1.31656.6.1.2.3.2.1.0"},
     {portalServerURL, "1.3.6.1.4.1.31656.6.1.2.2.6.0"  }
]).

%-define(AcIf,[
%     {ifDescr,       "1.3.6.1.4.1.31656.6.1.2.4.2.1.2"},
%     {ifType,        "1.3.6.1.4.1.31656.6.1.2.4.2.1.3"},
%     {ifMtu,         "1.3.6.1.4.1.31656.6.1.2.4.2.1.4"},
%     {ifSpeed,       "1.3.6.1.4.1.31656.6.1.2.4.2.1.5"},
%     {ifPhysAddress, "1.3.6.1.4.1.31656.6.1.2.4.2.1.6"},
%     {ifAdminStatus, "1.3.6.1.4.1.31656.6.1.2.4.2.1.7"},
%     {ifOperStatus,  "1.3.6.1.4.1.31656.6.1.2.4.2.1.8"}
%]).

-define(AcRadio,[
     {radiusAuthServerIPAdd, "1.3.6.1.4.1.31656.6.1.2.14.6.1.2"},
     {radiusAuthServerPort,  "1.3.6.1.4.1.31656.6.1.2.14.6.1.3"}
]).

-define(AcVlan,[
     {ipPoolName,      "1.3.6.1.4.1.31656.6.1.2.6.5.1.10"},
     {ipPoolStartAddr, "1.3.6.1.4.1.31656.6.1.2.6.5.1.2" },
     {ipPoolStopAddr,  "1.3.6.1.4.1.31656.6.1.2.6.5.1.3" }
]).

-define(Ap,[
     {apName,       "1.3.6.1.4.1.31656.6.1.1.1.1.1.2" },
     {apSerialNo,   "1.3.6.1.4.1.31656.6.1.1.1.1.1.11"},
     {apType,       "1.3.6.1.4.1.31656.6.1.1.1.1.1.5" },
     {apIp,         "1.3.6.1.4.1.31656.6.1.1.1.5.1.1" },
     {apMask,       "1.3.6.1.4.1.31656.6.1.1.1.5.1.2" },
     {apMac,        "1.3.6.1.4.1.31656.6.1.1.1.1.1.1" },
     {apSoftVersion,"1.3.6.1.4.1.31656.6.1.1.1.1.1.6" }
]).
...
-define(Acinfo, [
     ...
     %{normalNum,               "1.3.6.1.4.1.31656.6.1.2.13.4.1.6.0" }, %多值
     %{radiusAvgDelay,          "1.3.6.1.4.1.31656.6.1.2.14.2.1.14.0"},
     %{portalChallengeReqCount, "1.3.6.1.4.1.31656.6.1.2.3.1.24.0"   },
     %{portalChallengeRespCount,"1.3.6.1.4.1.31656.6.1.2.3.1.25.0"   },
     %{portalAuthReqCount,      "1.3.6.1.4.1.31656.6.1.2.3.1.26.0"   },
     %{portalAuthRespCount,     "1.3.6.1.4.1.31656.6.1.2.3.1.30.0"   },
  ]).
...
%%radio
-define(ApRadio,[
     {radioPeriod,  "1.3.6.1.4.1.31656.6.1.1.4.3.1.5" },
     {radioDtim,    "1.3.6.1.4.1.31656.6.1.1.4.3.1.7" },
     {radioRts,     "1.3.6.1.4.1.31656.6.1.1.4.3.1.8" },
     {radioSlice,   "1.3.6.1.4.1.31656.6.1.1.4.3.1.6" }
     %{radioModel,  "1.3.6.1.4.1.31656.6.1.1.3.3.1.13"},
...
-define(ApState, [
    {apState, "1.3.6.1.4.1.31656.6.1.1.2.5.1.10"}
]).
...
%%----------------------------------------------------------------------
-define(MonWireless, [
     {ifInOctets,    "1.3.6.1.4.1.31656.6.1.1.3.5.1.10"},
     {ifOutPkts,     "1.3.6.1.4.1.31656.6.1.1.3.5.1.8" },
     {ifInPkts,      "1.3.6.1.4.1.31656.6.1.1.3.5.1.9" },
     {ifOutOctets,   "1.3.6.1.4.1.31656.6.1.1.3.5.1.11"},
     {ifInErrors,    "1.3.6.1.4.1.31656.6.1.1.3.5.1.21"},
     {ifInAvgSignal, "1.3.6.1.4.1.31656.6.1.1.3.5.1.1" },
     {ifInHighSignal,"1.3.6.1.4.1.31656.6.1.1.3.5.1.2" },
     {ifInLowSignal, "1.3.6.1.4.1.31656.6.1.1.3.5.1.3" }
     %{ifFrameRetryRate,""}
]).

-define(MonWire, [
    {ifInUcastPkts,  "1.3.6.1.4.1.31656.6.1.1.3.2.1.1" },
    {ifInNUcastPkts, "1.3.6.1.4.1.31656.6.1.1.3.2.1.2" },
    {ifInOctets,     "1.3.6.1.4.1.31656.6.1.1.3.2.1.12"},
    {ifInDiscards,   "1.3.6.1.4.1.31656.6.1.1.3.2.1.4" },
    {ifInErrors,     "1.3.6.1.4.1.31656.6.1.1.3.2.1.5" },
    {ifOutUcastPkts, "1.3.6.1.4.1.31656.6.1.1.3.2.1.6" },
    {ifOutNUcastPkts,"1.3.6.1.4.1.31656.6.1.1.3.2.1.7" },
    {ifOutOctets,    "1.3.6.1.4.1.31656.6.1.1.3.2.1.13"},
    {ifOutDiscards,  "1.3.6.1.4.1.31656.6.1.1.3.2.1.9" },
    {ifOutErrors,    "1.3.6.1.4.1.31656.6.1.1.3.2.1.10"}  
  ]).
